  ...
  return (
    <>
      <header className="w-full h-auto flex flex-row bg-white bg-opacity-95 justify-between items-center py-3 px-5 fixed z-10">
        ...
        <div className="flex w-auto h-auto cursor-pointer">
          <img src="./images/icon-hamburger.svg" alt="menu" className="block" />
          <img src="./images/icon-close.svg" alt="close" className="hidden" />
        </div>
      </header>
      <NextGen />
    </>
